...
internal class DatabaseCleaningRoutinesTest {
    ...
    fun testGetTodayAndNextFiveDays() {
        ...
        val expectedList = listOf("2023-07-13","2023-07-14", "2023-07-15", "2023-07-16", "2023-07-17", "2023-07-18" )
        val receivedList = DatabaseCleaningRoutines().getTodayAndNextFiveDays(today)
